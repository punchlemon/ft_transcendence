      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        {mfaMessage ? (
          <div role="alert" className="mt-6 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
            ...
            <p className="mt-2 text-xs text-amber-800">Please open the 2FA code entry screen from the link below.</p>
        ...
        <div className="mt-8 border-t border-slate-200 pt-6">
          <p className="text-sm font-medium text-slate-700">Login with OAuth</p>
